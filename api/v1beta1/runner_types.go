...
type KubernetesConfig struct {
	...
	PullPolicy                                        []string                           `toml:"pull_policy,omitempty" json:"pull_policy" long:"pull-policy" env:"KUBERNETES_PULL_POLICY" description:"Policy for if/when to pull a container image (never, if-not-present, always). The cluster default will be used if not set"`
	...
	Volumes                                           KubernetesVolumes                  `toml:"volumes" json:"volumes"`
...
type KubernetesCSI struct {
	...
	ReadOnly         bool              `toml:"read_only,omitempty" json:"read_only,omitempty" json:"read_only,omitempty" description:"If this volume should be mounted read only"`
...
type KubernetesPodSecurityContext struct {
	FSGroup            *int64  `toml:"fs_group,omitempty" json:"fs_group" long:"fs-group" env:"KUBERNETES_POD_SECURITY_CONTEXT_FS_GROUP" description:"A special supplemental group that applies to all containers in a pod"`
